...
public class GuiExtremeCrafter extends GuiContainerTileBase<ContainerExtremeCrafter> {

	public static final ResourceLocation BACKGROUND = new ResourceLocation(PackagedAvaritia.MOD_ID, "textures/gui/extreme_crafter.png");

	public GuiExtremeCrafter(ContainerExtremeCrafter container) {
		super(container);
		xSize = 270;
		ySize = 274;
	}
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		fontRenderer.drawString(container.playerInventory.getDisplayName().getUnformattedText(), 56, ySize-96+3, 0x404040);
