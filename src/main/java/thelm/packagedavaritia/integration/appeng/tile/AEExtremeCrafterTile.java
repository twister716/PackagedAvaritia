...
public class AEExtremeCrafterTile extends ExtremeCrafterTile implements IGridHost, IActionHost {

	public boolean firstTick = true;
	public BaseGridBlock<AEExtremeCrafterTile> gridBlock;
	public IActionSource source;
	public IGridNode gridNode;

	public AEExtremeCrafterTile() {
		super();
